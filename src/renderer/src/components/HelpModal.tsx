...
export function HelpModal({
  ...
  // Close on Escape, trap Tab focus within the dialog, and give initial focus to close button.
  useEffect(() => {
    // Capture the triggering element now (at mount) so the cleanup can restore
    // focus reliably even if the ref changes after the modal unmounts.
    ...
    return () => {
      ...
      // Return focus to the triggering element when the dialog closes (WCAG 2.4.3)
      triggerEl?.focus()
    }
